 ...
 *   get:
 *     summary: Get comprehensive sleep data for a user
 *     tags: [Sleep]
 *     parameters:
 *       - in: path
 *         name: userId
 ...
 *     responses:
 *       200:
 *         description: The comprehensive sleep data
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                   type: boolean
 *                 data:
 *                   $ref: '#/components/schemas/ComprehensiveSleepData'
 *       400:
 *         description: Invalid user ID supplied
 *         content:
 *           application/json:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 *       404:
 *         description: No sleep data found
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/ErrorResponse'
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get("/:userId/comprehensive", sleepController.getComprehensiveSleepData);
