...
const DynamicInsights: React.FC = () => {
  ...
  return (
    ...
    >
      <Typography variant="h5" sx={{ pb: 2, textAlign: "center" }}>
        Dynamic Insights
      </Typography>
      <Typography
        variant="body1"
      ...
      >
        Discover interesting correlations between your daily activities and sleep
        patterns. This section highlights how different factors may be
        influencing your sleep quality.
      </Typography>
      <Divider sx={{ mb: 2 }} />
      <Accordion
        defaultExpanded
